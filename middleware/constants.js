...
export const MD_CAT_FIELDS = [
	...
	{ 
		...
		description: 'Local Area Information - Outside the hotel: all named attractions, businesses, venues, services, and amenities, plus their details such as distances, context, activities, food options, local transportation access, tour operators, seasonality, and any stated access rules or safety notes.',
		capture_guide: 'Do not drop or replace explicitly named places, businesses, or properties with generic labels. Capture all stated details.',
	...
	{
		name: 'meeting_events',
		description: 'Meeting & events - Spaces, services, and resources for hosting meetings, conferences, banquets, weddings, conventions, corporate events, and social gatherings, plus details including total square footage, room counts, room dimensions, capacities (banquet, theater, reception), room configurations and divisibility, ceiling heights, indoor/outdoor designation, named venues, catering and audiovisual partners, package inclusions (durations, bar tiers, tasting conditions, vendor meals, anniversary stays), planning services, banquet size ranges, on-site guest room inventory supporting events, group accommodation support, and related contact information.',
		capture_guide: 'Capture all stated Meeting & events details without omission, including room sizes, capacities, configurations, named venues, package inclusions and conditions, guest accommodation counts tied to events, service providers, and operational requirements when provided.',
		merge_guide: 'Do not drop or generalize room-specific dimensions, capacities, configurations, named venues, package inclusions or conditions, guest room inventory counts supporting events, or named partners. Preserve numeric details and relationships between spaces and their capacities.'
	},
	...
	},
	{
		...
		capture_guide: 'Capture all stated Recreation & fitness details without omission, including operational rules and facility-specific policies when provided.',
	},
