...
export const MD_CAT_FIELDS = [
	...
	{ name: 'local_area_information', description: 'Local Area Information - All named attractions, businesses, and venues (do not generalize to categories) and their details including exact distances and travel times, resort characteristics, historical and educational detail, structured activity lists, local food shopping and provisioning, marine and ferry access, named tour operators and animal-watch or charter companies, and seasonal or timing details' },
