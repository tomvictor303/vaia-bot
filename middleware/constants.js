...
export const MD_CAT_FIELDS = [
	...
	{ name: 'local_area_information', description: 'Local Area Information - Outside the hotel: all named attractions, businesses, venues, services, and amenities (do not generalize to categories), plus key details such as distances and travel times, resort characteristics, historical and educational notes, structured activity lists, local food shopping and provisioning, marine and ferry access, named tour operators and animal-watch or charter companies, and seasonal or timing details' },
